...
anova(model1)
pwr.f2.test(u = 1, v = 270, f2 = 0.35, sig.level = 0.05, power = ) # u is dfn. The dfn is the number of degrees of freedom that the estimate of variance used in the numerator is based on. v is dfd. The dfd is the number of degrees of freedom that the estimate used in the denominator is based on. 
